"""
Quick script to embed Module 2 chapters into RAG system.
"""
import os
import re
import requests
...
def main():
    base_path = Path("physical-ai-textbook/docs/docs/module-2-simulation")

    chapters = [
        base_path / "chapter-1-introduction-to-digital-twins.md",
        base_path / "chapter-2-robot-simulation-with-gazebo.md",
        base_path / "chapter-3-sensors-and-environments.md"
    ]

    print("=" * 60)
    print("Embedding Module 2 Chapters")
    print("=" * 60)
    print()
